...
import { formatDateTime, sortByUpdatedAt, titleize } from "@ring-gui/lib/format";
            ...
            <table>
              ...
              <tbody>
                {sessionItems.map((item) => (
                  <tr key={item.id}>
                    <td>
                      <AppLink to={`/sessions/${item.id}`} className="record-link">
                        {item.id}
                      </AppLink>
                    </td>
                    <td>
                    ...
                    <td>
                      {milestoneNameById.get(item.data.milestone_id) ??
                        item.data.milestone_id}
                    </td>
                    <td>{item.data.task_ids.length}</td>
